...
do_install () {
    ...
    ${@bb.utils.contains('MACHINE', 'sl1620', 'install -d ${D}/usr/share/synap/models; cp -r ${S}/models/object_detection ${D}/usr/share/synap/models/', '', d)}
    ${@bb.utils.contains('MACHINE', 'sl1640', 'cp ${S}/videos/h264/sl1640/* ${D}${rootdir}/demos/videos/h264/', '', d)}
    ${@bb.utils.contains('MACHINE', 'sl1680', 'cp ${S}/videos/h264/sl1680/* ${D}${rootdir}/demos/videos/h264/', '', d)}
}
