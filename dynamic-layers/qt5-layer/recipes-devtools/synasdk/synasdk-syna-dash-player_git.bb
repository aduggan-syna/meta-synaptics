SUMMARY = "Synaptics QT Dash Player"
SECTION = "multimedia"
LICENSE = "Apache-2.0"
...
S = "${WORKDIR}/${SYNA_SOURCE_PREFIX}/application/demos/qt5/syna-dash-player"
...
do_install () {
    install -d ${D}${bindir}
    install -m 0755 ${WORKDIR}/build/syna-dash-player ${D}${bindir}/
}

FILES:${PN} = " \
    ${bindir}/syna-dash-player \
"
